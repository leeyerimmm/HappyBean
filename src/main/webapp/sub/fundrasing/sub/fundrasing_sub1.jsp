...
<body>
  ...
  <div id="wrap">
    <section>
      ...
      <article class="content_container">
        <div class="article_content">
          <div class="introduce">
            ...
            <article class="fundrasing_sub1">
              ...
              <a class="plan_donate" href="javascript:void(0)" onclick="donateSubmit()"><strong>모금함 기부하기</strong></a>
		...
		<p class="status_btn">
		  <a href="<%= request.getContextPath() %>/payment/payment.jsp?subnum=<%= subnumParam %>&donation_type=<%= donation_type != null ? donation_type : "" %>">
		    모금함 기부하기
		  </a>
		</p>
  ...
  <script>
  	function donateSubmit() {
  		document.donateFrm.action= "<%= request.getContextPath() %>/payment/payment.jsp?subnum=<%= subnumParam %>&donation_type=<%= donation_type %>";
