...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/css/sub/funding/fundingPayment.css">
...
<body>
  <header>
    <div class="header-content">
      <div class="logo">
        <img src="${pageContext.request.contextPath}/images/common/logo_kr.svg" alt="N Pay">
      </div>
  ...
  <form action="./fundingPaymentProc.jsp" method="post" name="fundingFrm">
    <section>
          ...
          <div class="order-item">
            <div class="product-info-container">
              <div class="product-image">
                <img src="./images/<%= thumb %>.jpg" alt="상품 이미지">
              </div>
      ...
      <div class="payment-method-section">
        ...
        <div class="payment-method-content">
          <p class="register-text">결제수단을 선택해 주세요</p>
          <p class="register-subtext">설정한 수단으로 모든 펀딩 상품이 결제됩니다.</p>
          <%
          String formattedAmount = formatter.format(jBean.getAmount_held());
          %>
          <h2 style="font-size: 15px;" >
	          <input type="radio" checked> 해피빈 보유금액 :</input>
	          <span style="color: #4CAF50;"> <%= formattedAmount %>원</span>
          </h2>
	      <button style="margin-top: 10px;" class="register-button" type="button">등록하기</button>
        </div>
      </div>
      ...
      <div class="final-consent">
        ...
        <button type="button" class="submit-button" onclick="check()">펀딩결제 신청하기</button>
      </div>
    </section>
    <input type="hidden" name="amount_held" value="<%= jBean.getAmount_held() %>" />
  ...
  <script>
  	...
  	function check(){
  	  ...
  	  if(<%= jBean.getAmount_held() %> < <%= totalDelPrice %>){
  		  alert("해피빈 보유금액이 부족합니다.");
  		  return;
  	  }
