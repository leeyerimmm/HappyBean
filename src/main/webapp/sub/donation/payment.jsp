...
<html lang="ko">
  <head>
    ...
    <script defer src="${pageContext.request.contextPath}/js/common/common.js">
      payBeanInputValue();
    </script>
    <title>해피빈</title>
  </head>
  <body>
    ...
    <div id="wrap">
      <section id="payment">
        ...
        <section id="payment_form_wrap" class="w_max" >
          ...
          <!-- 보유금액 기부 form -->
          <form action="#" method="post" id="amount_pay_form" autocomplete="off">
            <ul class="pay_list">
              <li class="bean_info_frame">
                <h3>보유콩</h3>
                <strong class="current_bean">0</strong>개
                &#40 <strong class="conversion_bean">123456</strong>원 &#41
                <input type="checkbox" name="descOpen" id="descOpen" class="sr-only" checked>
                <label for="descOpen"><span class="sr-only">콩이란?</span></label>
                <div class="bean_desc_box">
              ...
              <li class="pay_choose_frame">
                <h3>기부 할 금액</h3>
                <input type="text" name="payBean" id="payBean" value="10000" oninput="formatInput()"><span>원</span>
                <input type="radio" name="choose_amount" id="choose_10000" class="sr-only" value="10000" onclick="updateValue()">
                <label for="choose_10000">1만원</label>
                <input type="radio" name="choose_amount" id="choose_20000" class="sr-only" value="20000" onclick="updateValue()">
                <label for="choose_20000">2만원</label>
                <input type="radio" name="choose_amount" id="choose_30000" class="sr-only" value="30000" onclick="updateValue()">
              ...
              <li class="agree_frame">
                <ul class="agree_list">
                  <li>                    
                      <input type="checkbox" name="agree" id="all_agree" class="sr-only all_agree" value="selectAll" onclick="selectAll(this)">
                      <label for="all_agree">이용약관, 마케팅 알림 수신에 모두 동의합니다.</label>                    
                  </li>
                  <li>
                    <input type="checkbox" name="agree" id="terms_agree" class="sr-only agree_check" value="동의" required>
    ...
    &lt;부칙&gt;
      ...
      적용 일자 : 2024.01.01
                  ...
                  <li>
                    <input type="checkbox" name="agree" id="ad_agree" class="sr-only agree_check" value="동의">
