...
- **결제 기능**:
  ...
  - 사용자는 기부 프로젝트에서 후원하기를 통해 결제할 수 있으며, 펀딩 프로젝트에서는는 참여하기를 통해 결제할 수 있습니다.
...
| 구분             | 설명                                                                                                                                                   | 이미지                                                 |
|------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------|
| **기부 결제 페이지** | 사용자가 기부할 금액을 입력하고, 결제할 수 있는 페이지입니다. 결제할 금액을 입력하고, 100% 기부를 선택한 후 '기부하기' 버튼을 클릭하여 기부를 완료할 수 있습니다.            | ![기부 결제 페이지](./images/donation_payment.png)     |
| **펀딩 결제 페이지** | 사용자가 펀딩 상품을 선택하고 결제할 수 있는 페이지입니다. 배송 정보와 결제 수단을 설정한 후 '펀딩결제 신청하기' 버튼을 클릭하여 펀딩을 완료할 수 있습니다. 결제 예정 금액이 명확히 표시됩니다. | ![펀딩 결제 페이지](./images/funding_payment.png)      |
